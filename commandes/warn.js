...
if(verifAdmin || superUser) {
   ...
   if( warn >= warnlimit ) { await repondre('this stupidy reach limit of warning , so i kick him/her now');
    ...
    repondre('you are not an admin please promote XPHOTOGRAPHER-MD to warn stupidy people')
}
